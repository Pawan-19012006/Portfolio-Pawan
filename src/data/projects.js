export const PROJECTS_DATA = [
  {
    ...
    highlights: [
      ...
      "Scalable healthcare workflow management"
    ]
  },
  {
    id: "devwatch",
    ...
    isFeatured: true,
    highlights: [
      "Project-aware system intelligence",
  ...
  },
  {
    ...
    highlights: [
      ...
      "EdTech + FinTech hybrid platform"
    ]
  },
  {
    id: "skilltrader",
  ...
  },
  {
    id: "quickrate",
    title: "QuickRate",
    description: "QuickRate is a lightweight browser-based currency converter focused on simplicity, speed, and zero-backend deployment.",
    category: "Utility Web Application",
    techStack: ["HTML", "JavaScript"],
    githubUrl: "https://github.com/Pawan-19012006/QuickRate",
    liveUrl: "#",
    status: "Completed",
    isFeatured: false,
    highlights: [
...
export const PROJECT_CATEGORIES = [
  ...
  "Developer Tooling / Linux Systems",
  "Enterprise Workflow Platform",
  "FinTech / Gamified Learning",
  "Social Learning Platform",
  "Secure Assessment Platform",
  "Offline-First Event Management",
